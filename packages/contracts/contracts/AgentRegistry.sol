...
/**
 * @title AgentRegistry
 * @dev Registry for AI agents with staking and reputation
 * 
 * Features:
...
contract AgentRegistry is Ownable, ReentrancyGuard {
    ...
    constructor(address _agntToken, address _owner) Ownable(_owner) {
    ...
    function registerAgent(
        ...
        // Transfer stake
        agntToken.safeTransferFrom(msg.sender, address(this), stakeAmount);
    ...
    function withdrawStake(bytes32 agentId, uint256 amount) external nonReentrant onlyAgentOwner(agentId) {
        ...
        agntToken.safeTransfer(msg.sender, amount);
